...
public class SearchRepository {
    ...
    public Page<UserDetailResponse> findAllUsersByCustomizeQuery(String firstName, String lastName, Integer gender, int pageNo, int pageSize) {
        ...
        // Get list of users
        Query selectQuery = entityManager.createQuery(String.format("SELECT new com.sample.dto.response.UserDetailResponse(u.id, u.firstName, u.lastName, u.email, u.phone) FROM User u %s ORDER BY u.id DESC", where));
